...
class _TarefasViewState extends State<TarefasView> {
  ...
  final _db = FirebaseFirestore
      .instance; //controler para enviar tarefas para o bando de dados firestore
  final User? _user =
  ...
  void _updateTarefaStatus(String id, bool concluida) async {
    try {
      await _db
          .collection("usuarios")
          .doc(_user!.uid)
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        leading: Checkbox(
                          ...
                          onChanged: (value) {
                            if (value != null) {
                              _updateTarefaStatus(tarefa.id, value);
                            }
                          },
                        ),
                        trailing: IconButton(
