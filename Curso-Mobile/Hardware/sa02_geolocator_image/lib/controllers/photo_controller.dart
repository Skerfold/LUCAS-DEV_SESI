...
class PhotoController {
  ...
  Future<Photo> photoWithLocation() async {
    ...
    final picker = ImagePicker(); //obj controlador do uso da camera/galeria
    String photoPath = '';
    ...
    if (pickedFile != null) {
      ...
      final result = await http.get(
        Uri.parse(
          'http://api.openWeathermap.org/data/2.5/weather?appid=$apiKey&q=${position.latitude},${position.longitude}',
        ),
      );
