...
class _PetDetalheScreenState extends State<PetDetalheScreen> {
  ...
  List<Consulta> _consultas = []; // Lista está inicialmente vazia
    ...
    return Scaffold(
      ...
      body:
          _isLoading
              ...
              : _pet ==
                  null // Verifica se o pet foi carregado
              ? const Center(
                child: Text("Erro ao carregar o Pet. Verifique o ID."),
              )
              : Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _consultas.isEmpty
                        ? const Center(
                          child: Text(
                            "Não existem consultas cadastradas para este pet.",
                          ),
                        )
                        : Expanded(
